...
| Fleet wake          | A `thread.turn.start` sent with `fleetWake: true`, which First Mate uses to wake its own agent. The turn runs as any other. Its user message keeps `fleetWake`, and clients show it as a folded "Fleet notice" line instead of a message the user typed.                                                                                                                                                                                                                                                                                                                                                              |
